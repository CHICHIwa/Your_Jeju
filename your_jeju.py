...
final_downtown_review_1 = load_model("Jeju/final_downtown_review_1.pkl")
...
pages = [
    ...
    Page("농협카드 - 데이터 확인", 
         ...
         graph_descriptions=[
             ...
             "첫 번째 래그(lag)에서 1의 값을 가지고 이후 래그에서 상관관계가 빠르게 감소하고있기에 어느정도 정상성을 가진다고 판단.",
    ...
    Page("제주도의 미래 소비 예측을 위한 Prophet모델링", 
         ...
         graph_descriptions=[
             ...
             "분석 결과 앞으로는 전체 소비가 감소하는 추세를 보여주고 있습니다. 관광산업의 부흥을 위해 다양한 분석을 시작하겠습니다."
         ],
         images=[present_jeju]
    ), 
    Page("동반자 유형 & 관광지 분석", 
         ...
         graph_descriptions=[
             "1월부터 9월까지는 주로 가족 단위 관광객이 많았으며, 9월부터 12월까지는 친구와 함께 방문한 관광객이 증가하였습니다.",
             "'휴식과 치유 여행'이 가장 인기 있는 키워드였습니다. 동반자 유형별로 주목한 키워드에 차이가 존재하고 있습니다.",
             "천지연폭포는 다른 폭포들과 달리, 1월부터 4월까지 관광객 수가 급증한 후, 그 이후로는 방문객 수가 현저히 감소하는 추세를 확인할 수 있습니다.다른 관광지들은 대체로 비슷한 수준의 방문객을 유지하고 있습니다.",
